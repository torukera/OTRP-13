local internalNpcName = "Loot Assistant"
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome, my shop buy almost everything!")
...
npcConfig.shop = {
	...
	{ itemName = "empty potion flask", clientId = 283 },
	{ itemName = "empty potion flask", clientId = 284 },
	{ itemName = "empty potion flask", clientId = 285 },
	...
	{ itemName = "stone skin amulet", clientId = 3081, buy = 10000, sell = 500, count = 5 },
	...
	{ itemName = "might ring", clientId = 3048, buy = 10000, sell = 250, count = 20 },
